...
#logo
image = Image.open("C:/Users/FLIVO/Desktop/FACE RECOGNIZATION CLASS ATTENDANCE/tenant management system/pic2.png")
...
image2 = Image.open("C:/Users/FLIVO/Desktop/FACE RECOGNIZATION CLASS ATTENDANCE/tenant management system/pic2.png")
...
first.place(x=self.left_x,y=90)
first_entry=ctk.CTkEntry(master=profile,text_color="black",width=180,height=33)
first_entry.place(x=self.left_x,y=130)
#must
image3 = Image.open("C:/Users/FLIVO/Desktop/FACE RECOGNIZATION CLASS ATTENDANCE/tenant management system/star.png")
